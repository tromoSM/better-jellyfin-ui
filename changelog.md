...
| 1.16 | 17 | <ul><li>Fix issue #16</li><li>Made all the blur values variables and added to manual options - @Aceman67</li></ul> | 26.06.26 |
| 1.17 | 18 | <ul><li>removed extra padding from all the headers</li><li>Fix issue #feedback/request_2 (reporter chose to be anonymous) reported from <a href="https://tromosm.gt.tc/?utm_source=jellychangelog&feedback=true">here</a> - extra height in header inside media player if using plugin/<a href="https://github.com/tromoSM/better-jellyfin-ui/blob/main/options/Floating-header.css">floating header</a></li><li>add glass effect to header inside media player when using plugin/<a href="https://github.com/tromoSM/better-jellyfin-ui/blob/main/options/Floating-header.css">floating header</a></li></ul> | 26.09.03 |
